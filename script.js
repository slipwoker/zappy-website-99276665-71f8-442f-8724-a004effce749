        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '99276665-71f8-442f-8724-a004effce749',
                name: data.name || '',
                email: data.email || '',
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "roof chic uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
